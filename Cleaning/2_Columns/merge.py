...
df1 = pd.read_csv("datasets/Covid-19 Nursing Home Data/faclevel_2020.csv")
df2 = pd.read_csv("datasets/Covid-19 Nursing Home Data/faclevel_2021.csv")
df3 = pd.read_csv("datasets/Covid-19 Nursing Home Data/faclevel_2022.csv")
